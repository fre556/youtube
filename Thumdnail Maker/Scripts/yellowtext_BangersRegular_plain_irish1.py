...
def create_thumbnail_with_effect(image, output_path, config_path, weights_path, classes_path, subscribe_image_path, irish1_image_path, text="Rediscover The Past", font_path="Fonts/Bangers-Regular.ttf"):
    ...
    try:
        ...
        subscribe_image = subscribe_image.resize((200, 200), Image.LANCZOS)
    ...
    try:
        ...
        irish1_image = irish1_image.resize((300, 300), Image.LANCZOS)
...
def main(start_label, end_label, video_dir, screenshot_dir, config_path, weights_path, classes_path, subscribe_image_path, irish1_image_path):
    ...
    for label in range(start_label, end_label + 1):
        ...
        if os.path.exists(video_path):
            ...
            if frame is not None:
                ...
                create_thumbnail_with_effect(image, screenshot_path, config_path, weights_path, classes_path, subscribe_image_path, irish1_image_path)
...
if __name__ == "__main__":
    ...
    video_dir = 'D:/Test Batch Yt/1-1000'
    screenshot_dir = 'screenshots'
    config_path = 'yolov3.cfg'
    weights_path = 'yolov3.weights'
    classes_path = 'coco.names'
    subscribe_image_path = 'Assets/subscribe.png'
    irish1_image_path = 'Assets/irish1.png'
    main(start_label, end_label, video_dir, screenshot_dir, config_path, weights_path, classes_path, subscribe_image_path, irish1_image_path)
