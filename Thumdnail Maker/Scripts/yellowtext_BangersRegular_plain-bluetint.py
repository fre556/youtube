...
def add_blue_tint(image):
    print("Adding blue tint to image.")
    blue_tint = Image.new('RGB', image.size, (0, 0, 255))  # Create a blue image
    blended_image = Image.blend(image, blue_tint, alpha=0.3)  # Blend the images
...
def create_thumbnail_with_effect(image, output_path, config_path, weights_path, classes_path, subscribe_image_path, text="Rediscover The Past", font_path="Fonts/Bangers-Regular.ttf"):
