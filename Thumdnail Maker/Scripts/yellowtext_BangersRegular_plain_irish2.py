...
def create_thumbnail_with_effect(image, output_path, config_path, weights_path, classes_path, subscribe_image_path, irish1_image_path, text="Ireland Through the Ages", font_path="Fonts/Bangers-Regular.ttf"):
...
if __name__ == "__main__":
    ...
    irish1_image_path = 'Assets/irish3.png'
